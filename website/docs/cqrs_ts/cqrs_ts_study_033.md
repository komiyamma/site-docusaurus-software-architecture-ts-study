...
## 速くするコツは「計算しないで、貯める」💰✨
![cqrs_ts_study_033_incremental_aggregation.png](./picture/cqrs_ts_study_033_incremental_aggregation.png)

```mermaid
flowchart LR
  E[Domain Event
  OrderPaid: 500 yen] --> P[Projector]
  subgraph Read_Model [Read Model: sales_daily]
    direction LR
    Current[Total: 1000 yen] -- update --> Next[Total: 1500 yen]
  end
  P -- "+500" --> Current
```
