...
![cqrs_ts_study_018_formatting.png](./picture/cqrs_ts_study_018_formatting.png)

```mermaid
flowchart LR
  subgraph Raw_Data ["Raw Data (Internal)"]
    A["amount: 680"]
    S["status: 'ORDERED'"]
    C["createdAt: Date"]
  end
  subgraph UI_DTO ["Read DTO (View)"]
    AT[totalYenText: '¥680']
    SL[statusLabel: '支払い待ち']
    CT[createdAtText: '12:03']
  end
  A -- Formatting --> AT
  S -- Labeling --> SL
  C -- Formatting --> CT
