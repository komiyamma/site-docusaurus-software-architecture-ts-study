...
## 1) まず結論：エラーは3種類に分けよう🧺✨
![cqrs_ts_study_021_error_types.png](./picture/cqrs_ts_study_021_error_types.png)

```mermaid
flowchart TD
  E[Error Occurrence] --> D{Is it a business rule?}
  D -- Yes --> DE[Domain Error
  User Facing OK]
  D -- No --> I{Is it external?}
  I -- Yes --> IE[Infra Error
  Retry / Log]
  I -- No --> BE[Unexpected Bug
  Alert / Fix]
  style DE fill:#e1f5fe,stroke:#01579b
  style IE fill:#fff9c4,stroke:#fbc02d
