...
## 1) 不変条件ってなに？🤔🛡️
![cqrs_ts_study_011_invariants.png](./picture/cqrs_ts_study_011_invariants.png)
...
![cqrs_ts_study_011_two_tiered.png](./picture/cqrs_ts_study_011_two_tiered.png)

```mermaid
flowchart TD
  U[User Input] --> V1["A. 入口チェック (Zod等)"]
  V1 -- OK --> D[CommandHandler]
  D --> V2["B. ドメインチェック (Order等)"]
  V2 -- OK --> S[保存 / Execution]
