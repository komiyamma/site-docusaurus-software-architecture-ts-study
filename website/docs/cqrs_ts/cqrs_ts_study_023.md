...
![cqrs_ts_study_023_testing_mock.png](./picture/cqrs_ts_study_023_testing_mock.png)

```mermaid
flowchart LR
  subgraph Test_Target [Test Target]
    H[CommandHandler]
  end
  subgraph Mocks [Mocks / Fakes]
    R[Repository]
    P[PaymentGateway]
    C[Clock]
  end
  ...
  H -- Call --> P
  H -- Call --> C
  style Test_Target fill:#e3f2fd,stroke:#1e88e5
```
