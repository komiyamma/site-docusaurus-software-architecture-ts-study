...
### 2) 影響範囲（Blast Radius）💣
![cqrs_ts_study_005_blast_radius.png](./picture/cqrs_ts_study_005_blast_radius.png)

```mermaid
flowchart TD
  C[Change] -- Impact --> A[Component A]
  A -- Impact --> B[Component B]
  B -- Impact --> D[Component D]
