...
![SemVer Icons](./picture/api_contract_ts_study_007_semver_icons.png)
...
```mermaid
flowchart TD
    Start[変更発生] --> Q1{利用者が壊れる？<br>ビルド/実行/意味}
    Q1 -- Yes --> Major[MAJOR 😱]
    Q1 -- No --> Q2{新機能増えた？}
    Q2 -- Yes --> Minor[MINOR ✨]
    Q2 -- No --> Patch[PATCH 🩹]
...
![Version Ranges](./picture/api_contract_ts_study_007_version_ranges.png)
