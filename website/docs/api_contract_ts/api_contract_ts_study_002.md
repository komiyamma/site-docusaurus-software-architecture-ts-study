...
もし何も考えずに、ある関数の「引数の型」を変えちゃったらどうなるかな？🤔
...
![Three Types of Breaking Changes](./picture/api_contract_ts_study_002_compat_bins.png)
...
flowchart TD
    ...
    Check -->|コンパイルエラー| A[ビルド落ち🟥<br>安全！すぐ気づく]
    Check -->|起動時に死ぬ| B[実行時エラー💣<br>テストで気づけるかも]
    Check -->|動くけど結果が違う| C[サイレント破壊😇<br>一番怖い...]
```
