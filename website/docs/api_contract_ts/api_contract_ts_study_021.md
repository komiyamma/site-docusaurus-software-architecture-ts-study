...
![Dual Compatibility Migration](./picture/api_contract_ts_study_021_dual_compatibility.png)
...
```mermaid
flowchart TD
    Step1[Step 1: 読む側を強くする<br>Both v1 & v2] --> Step2[Step 2: 書く側を新しく<br>Write v2 Only]
    Step2 --> Step3[Step 3: 過去データ変換<br>Backfill v1->v2]
    Step3 --> Step4[Step 4: v1廃止<br>Cleanup]
```
