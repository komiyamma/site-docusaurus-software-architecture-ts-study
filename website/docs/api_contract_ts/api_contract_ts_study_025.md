...
![Migration Timeline](./picture/api_contract_ts_study_025_ver_migration_timeline.png)
...
gantt
    ...
    section 告知
    Deprecation Header付与  :a1, 2026-01-01, 30d
    個別連絡 (Top N)       :a2, 2026-01-15, 15d
    section サポート
    Level A (Full)        :b1, 2026-01-01, 30d
    Level B (Maint)       :b2, after b1, 30d
    Level C (Stop New)    :b3, after b2, 30d
    section 停止
    Sunset (410 Gone)     :crit, 2026-04-01, 1d
```
