...
![Step-by-Step Migration](./picture/api_contract_ts_study_011_step_migration.png)
...
## 11-3. 4ステップ移行テンプレ 🗺️✨
![Deprecation Flow](./picture/api_contract_ts_study_011_deprecate_flow.png)
...
```mermaid
flowchart LR
    S1[Step 1: 新を追加➕] --> S2[Step 2: 旧を非推奨🚧]
    S2 --> S3[Step 3: 新を標準化🎛️]
    S3 --> S4[Step 4: 旧を削除🗑️]
```
