...
![Safe Release Flow](./picture/api_contract_ts_study_027_safe_release_flow.png)
...
```mermaid
flowchart LR
    P1[Phase 1: Expand<br>拡張] -->|New field追加| P2[Phase 2: Migrate<br>移行]
    P2 -->|利用率監視| P2
    P2 -->|Old field削除| P3[Phase 3: Contract<br>収縮]
