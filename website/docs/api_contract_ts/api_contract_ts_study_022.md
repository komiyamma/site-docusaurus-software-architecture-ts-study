...
![API Foundation Puzzle](./picture/api_contract_ts_study_022_api_foundations.png)
...
```mermaid
flowchart LR
    Req[入力 Request] -->|Path / Query / Body| API[API処理]
    API -->|Status / Body| Res[出力 Response]
...
![Problem Details Standard](./picture/api_contract_ts_study_022_problem_details.png)
