...
![Type Check at Boundary](./picture/api_contract_ts_study_004_type_gate.png)
...
```mermaid
flowchart TD
    Input[外部入力<br>API/JSONなど] -->|unknown| Gate{境界チェック}
    Gate -->|isUser OK?| Safe[型安全な世界<br>User型として扱う]
    Gate -->|NG| Error[エラーとして弾く<br>throw Error]
    
    style Input fill:#f9f,stroke:#333,stroke-width:2px
    style Safe fill:#ccf,stroke:#333,stroke-width:2px
```
...
## 4. “構造的部分型（Structural Typing）”という約束の形⚖️✨

![Structural Typing (Duck Typing)](./picture/api_contract_ts_study_004_structural_typing.png)

TypeScriptの型システムで一番おもしろくて大事なのが **「名前じゃなくて“形”が合っていればOK」** っていうルールだよ🦆
...
![Brand Types](./picture/api_contract_ts_study_004_brand_types.png)
