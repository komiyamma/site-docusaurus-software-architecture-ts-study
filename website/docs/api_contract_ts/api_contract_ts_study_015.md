...
![Stability Metaphor](./picture/api_contract_ts_study_015_stable_volatile.png)
...
![Dependency Circles](./picture/api_contract_ts_study_015_inner_outer.png)
...
```mermaid
graph TD
    subgraph Outer[外側: 詳細・実装]
        UI[Web UI]
        DB[Database]
        API[External API]
    end
    subgraph Boundary[境界: 契約]
        Ports[Ports / Interfaces]
    end
    subgraph Inner[内側: ルール]
        App[Use Cases]
        Domain[Domain / Rules]
    end
    ...
    style Inner fill:#ccf,stroke:#333
```
