...
![npm Distribution Pitfalls](./picture/api_contract_ts_study_014_npm_pitfalls.png)
...
```mermaid
flowchart TD
    Req[利用者の要求] --> Check{import / require?}
    Check -->|import| ESM[ESM: .mjs / .js]
    Check -->|require| CJS[CJS: .cjs]
    Check -->|default| Def[Default: .js]
```
