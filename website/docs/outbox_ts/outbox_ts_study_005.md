...
```mermaid
flowchart LR
    StateA[アプリA<br/>注文完了!] -- "時間差🕰️" --> StateB[通知サービス<br/>通知済み!]
    style StateA fill:#e1f5fe,stroke:#01579b
    style StateB fill:#e8f5e9,stroke:#1b5e20
```

![timeline](./picture/outbox_ts_study_005_timeline.png)
